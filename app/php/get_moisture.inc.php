...
function get_selected_sensor_values($db, $db_table, $sname = "Unknown", $sloc = "Unknown") {
  ...
  try {
    $result = $db->query("SELECT timestamp, value FROM $db_table where sensor_name like '$sname' and location like '$sloc';");
